...
"""
""" Lidar Systems """
lidar_system = {'MULHACEN': 'mhc', 'VELETA': 'vlt','KASCAL':'kal'}
lidar_id = "gr"
...
def rayleigh_fit(**kwargs):
    ...
    if np.logical_or(output_dn is None, output_dn == "GFATserver"):
        ...
        output_dn = os.path.join(output_dn, lidar_name, "QA", "rayleigh_fit")
    # pdb.set_trace()
...
def telecover(dateini, zmin=2000, zmax=2500, input_directory='GFATserver',
    ...
    if output_directory == "GFATserver":        
        ...
        main_output_directory = os.path.join(output_directory, "KASCAL", "QA", "telecover")
...
def depolarization_cal(**kwargs):
    ...
    if np.logical_or(output_dn is None, output_dn == "GFATserver"):
        ...
        output_dn = os.path.join(output_dn, lidar_name, "QA", "depolarization_calibration")
